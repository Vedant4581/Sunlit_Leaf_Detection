...
from models.densenext_unet import DenseNeXtUNet
from models.densenext_unetpp import DenseNeXtUNetPP
from models.mbnext_unetpp import MBNeXtUNetPP
...
def main(args):
    ...
    elif args.model == "densenext_unet":
        model = DenseNeXtUNet(
            n_classes=2,
            in_channels=args.in_ch,
            growth=args.dnu_growth,
...
if __name__ == "__main__":
    ...
    ap.add_argument("--dec-depth", type=int, default=2, help="UNet++ columns depth (for densenext_unetpp)")
    ...
    ap.add_argument("--out", default="runs/mbnupp", help="Output directory")
    ...
    ap.add_argument("--ema", type=int, default=1, help="Use EMA for evaluation (0/1)")
